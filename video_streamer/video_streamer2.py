...
# """
#
# def create_streamer_local(file, connect_to='tcp://127.0.0.1:5566', loop=True):
#     """
...
#     streamer = create_streamer_local('/home/jackrma/Code/Multi-Camera-Live-Object-Tracking-master/video/2.mp4')
...
def create_streamer(connect_to='tcp://127.0.0.1:5566', loop=False):
    """
    您可以使用此功能模拟计数应用程序的IP摄像头。
    Parameters 参数
    ----------
    ...
    # 直接读摄像头   ##################
    cap = cv2.VideoCapture(2)  # 0 指本地摄像头 其他数字为usb摄像头
